...
function sortStocksByPricingLowToHigh(stock1, stock2) {
  return stock1.price - stock2.price;
}

function sortStocksByPricingHighToLow(stock1, stock2) {
...
app.get('/stocks/sort/pricing', (req, res) => {
  ...
  if (pricing === 'high-to-low') {
    sortedStocks.sort(sortStocksByPricingHighToLow);
  } else {
    sortedStocks.sort(sortStocksByPricingLowToHigh);
  }
